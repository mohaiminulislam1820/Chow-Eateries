    ...
    return (
        <div className="bg-white shadow-md border rounded w-10/12 sm:w-3/4 lg:w-5/12 mx-auto px-8 pt-14 pb-8 mb-4 flex flex-col mt-28">
            ...
            <div className='flex justify-around gap-6'>
                <button className="bg-white text-slate-800 border border-slate-600 font-bold py-2 px-4 rounded-lg" type="button">
                ...
                <button className="bg-white text-slate-800 font-bold py-2 px-4 rounded-lg border border-slate-600" type="button">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/c/c2/GitHub_Invertocat_Logo.svg" alt="google logo" className='w-7 inline mr-2' />
