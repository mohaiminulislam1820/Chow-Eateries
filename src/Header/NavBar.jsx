            ...
            <div>
               ...
               : user
                ?<div className='flex flex-wrap gap-x-4 gap-y-6 items-center'>
                    <img src={user.photoURL} alt="profile photo" className='w-14 h-14 border-2 border-yellow-300 object-cover inline  rounded-full' />
                    <p className='inline  hidden'>{user.displayName || ''}</p>
